...
**                                                                            **
*******************************************************************************/
/* [cover parentID={CDC53A42-9F15-4a14-877A-1DF68CCE5ED1}]
       tracing to MemMap file
   [/cover] */
#define MEMMAP_ERROR
...
#elif defined GPT_START_SEC_VAR_INIT_ASIL_B_GLOBAL_UNSPECIFIED
#ifdef _TASKING_C_TRICORE_
...
#undef MEMMAP_ERROR
#elif defined GPT_STOP_SEC_VAR_INIT_ASIL_B_GLOBAL_UNSPECIFIED
#ifdef _TASKING_C_TRICORE_
#pragma align restore
#pragma section fardata restore
#elif defined _GNU_C_TRICORE_
