...
#define MAIN_SW_START_ADDR                                        (0x80048000UL)
#define MAIN_SW_END_ADDR                                          (0x80FFFFFFUL)
#define MAIN_SW_SW_MODULE_INFO_ADDR            ((Fbl_SwModuleInfo*)0x80048020UL)
#define MAIN_SW_SECURITY_KEY_ADDR                                 (0x80048100UL)
#define MAIN_SW_CRC_INFO_ADDR                       ((Fbl_CrcInfo*)0x80048200UL)
