...
FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Main(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Main(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Sub1(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Sub1(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Sub2(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Sub2(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Sub3(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Sub3(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Sub4(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Sub4(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Start_EcucPartition_Sub5(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_Stop_EcucPartition_Sub5(VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Main(void);
FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Sub1(void);
FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Sub2(void);
FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Sub3(void);
FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Sub4(void);
FUNC(void, RTE_CODE) Rte_PartitionTerminated_EcucPartition_Sub5(void);
FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Sub4 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Sub4 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Sub1 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Sub1 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Sub2 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Sub2 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Sub3 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Sub3 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Sub5 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Sub5 (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Init_EcucPartition_Main (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);

FUNC(void, RTE_CODE) SchM_Deinit_EcucPartition_Main (VAR(uint8, RTE_DATA) LddRte_GaaInitFlag);
