...
*******************************************************************************/
/*
 * INPUT FILE:    D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Pwm.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Mcu.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Gpt.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Adc.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Port.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Ecud_IoHwAb.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Icu.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Dio.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Ecud_Os.arxml
 *                D:\02_DCU-15\01_HKMC_RS4\01_develop\Configuration\Ecu\Mcal\Ecud_Spi.arxml
...
#define IOHWAB_SW_MINOR_VERSION                            (7)
...
#define IOHWAB_USE_DIG_IN                             (STD_ON)
...
#define IOHWAB_USE_DIG_OUT                            (STD_ON)
...
**                      General                                               **
*******************************************************************************/
#define IOHWAB_MCAL_INFINEON_TC39X                    

#define IOHWAB_GEN_NUM_PORT_PIN_CHS                   (4U)
...
#define IoHwAbDigitalDirectLogical_DIGITAL_DIRECT_INPUT (0U)
#define IoHwAbDigitalDirectLogical_OS_TASK_OUTPUT     (1U)
...
**                      Analog Input Direct                                   **
*******************************************************************************/
#define IOHWAB_ANAINDIR_NUM_ADC_GROUPS                (10U)

#define IOHWAB_ANAINDIR_NUM_LGC                       (11U)

#define IOHWAB_ANAINDIR_MAX_BUF_LENGTH                (1U)

#define IoHwAbAnalogInputDirectLogical_ADC_SAMPLE_0   (0U)
#define IoHwAbAnalogInputDirectLogical_AN10_DVDD_3_3V_MCU (1U)
#define IoHwAbAnalogInputDirectLogical_AN11_VDD_1_25V_MCU_Core (2U)
#define IoHwAbAnalogInputDirectLogical_AN12_DVDD_5V_CAN (3U)
#define IoHwAbAnalogInputDirectLogical_AN21_VBAT      (4U)
#define IoHwAbAnalogInputDirectLogical_AN27_Thermistor (5U)
#define IoHwAbAnalogInputDirectLogical_AN2_IGN        (6U)
#define IoHwAbAnalogInputDirectLogical_AN4_DVDD_5V_CAN_PG (7U)
#define IoHwAbAnalogInputDirectLogical_AN9_DVDD_5V_MCU (8U)
#define IoHwAbAnalogInputDirectLogical_BatteryVoltage (9U)
...
#define IOHWAB_ANAIN_NUM_MAX_CHS_IN_UNIT              (16U)

#define IoHwAbAnalogInputLogical_ADC_SAMPLE_1         (0U)

#define IOHWAB_ANAIN_BUSY_ERR                         (RTE_E_IoHwAb_If_AnaIn_E_BUSY)

#define IOHWAB_ADCHWUNIT_MAX_NUM                      (9U)

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc0AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc10AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc11AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc1AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc2AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc3AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc4AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc8AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
void bianadir_Adc9AllGrpNf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"
...
**                      Digital Input                                         **
*******************************************************************************/
#define IOHWAB_NUM_DIGIN_MCU_LGC                      (1U)

#define IOHWAB_NUM_DIGIN_LGC                          (1U)

#define IOHWAB_NUM_DIGIN_RAW_BUFFER                   (1U)

#define IOHWAB_NUM_DIGIN_FAST_HIGH                    (0U)

#define IOHWAB_NUM_DIGIN_FAST_LOW                     (1U)

#define IOHWAB_NUM_DIGIN_FAST                         (1U)

#define IOHWAB_NUM_DIGIN_SLOW_LOW                     (0U)

#define IOHWAB_NUM_DIGIN_SLOW_HIGH                    (0U)

#define IOHWAB_NUM_DIGIN_SLOW                         (0U)

#define IoHwAbDigitalInputLogical_DIGITAL_INPUT_SAMPLE_0 (0U)

#define IOHWAB_START_SEC_VAR_CLEARED_8
#include "MemMap.h"
extern VAR(uint8, IOHWAB_VAR)IoHwAb_GaaDigInFiltBuffer[];
#define IOHWAB_STOP_SEC_VAR_CLEARED_8
#include "MemMap.h"

typedef struct STag_IoHwAb_DigInRawBufferType
{
  uint8 ucTempBuffer;
  uint8 ucRawBuffer;
}IoHwAb_DigInRawBufferType;

#define IOHWAB_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
extern VAR(IoHwAb_DigInRawBufferType, IOHWAB_VAR)IoHwAb_GaaDigInRawBuffer[];
#define IOHWAB_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"

typedef struct STag_IoHwAb_DigInInfoPropertyType
{
  IoHwAb_IndexType ddRefChIdx;
  uint8 ucFiltConst;
}IoHwAb_DigInInfoPropertyType;

#define IOHWAB_START_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
extern CONST(IoHwAb_DigInInfoPropertyType, IOHWAB_CONST)IoHwAb_GaaDigInInfos[];
#define IOHWAB_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
...
**                      Digital Output                                        **
*******************************************************************************/
#define IOHWAB_NUM_DIGOUT_MCU_LGC                     (1U)

#define IOHWAB_NUM_DIGOUT_LGC                         (1U)

#define IOHWAB_NUM_DIGOUT_MCU_BUFFER                  (1U)

#define IOHWAB_NUM_DIGOUT_RESULT_BUFFER               (1U)

#define IoHwAbDigitalOutputLogical_DIGITAL_OUTPUT_SAMPLE_0 (0U)

#define IOHWAB_START_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
extern CONST(IoHwAb_IndexType, IOHWAB_CONST)IoHwAb_GaaDigOutChIdx[];
#define IOHWAB_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"

#define IOHWAB_START_SEC_CONST_8
#include "MemMap.h"
extern CONST(uint8, IOHWAB_CONST)IoHwAb_GaaDigOutDefVal[];
#define IOHWAB_STOP_SEC_CONST_8
#include "MemMap.h"

typedef struct STag_IoHwAb_DigOutResultBufferType
{
  uint8 ucTempResult;
  uint8 ucResult;
}IoHwAb_DigOutResultBufferType;

#define IOHWAB_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
extern VAR(IoHwAb_DigOutResultBufferType, IOHWAB_VAR)IoHwAb_GaaDigOutResultBuffer[];
#define IOHWAB_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
...
#define IOHWAB_VOLMON_DEFAULT_VALUE                   (512U)

/* IoHwAbAdcGroup_AN46_Dummy */
#define IOHWAB_VOLMON_ADC_CH_IDX                      (10U)
...
#define IoHwAbGptLogical_IoHwAbTest                   (0U)
