...
#define DEM_MAX_LISTOFCOMBINEDEVENTS (75)
...
#define DEM_MAX_NUMBER_OF_DTC (77)
...
#define DEM_NUMBER_OF_EVENTS (173)

/* Total DEM_NUMBER_OF_INDICATORS entries */
#define DEM_NUMBER_OF_INDICATORS (74)

/* Total DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER entries */
#define DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER (75)
...
#define DEM_MAX_EVENT_PER_CYCLE 173
...
#define DemConf_DemStorageCondition_DemStorageCondition0  \
...
#define DemConf_DemEventParameter_ECUM_E_CONFIGURATION_DATA_INCONSISTENT\
  ((Dem_EventIdType)18)
#define DemConf_DemEventParameter_ECUM_E_RAM_CHECK_FAILED  ((Dem_EventIdType)19)
#define DemConf_DemEventParameter_DEM_E_TEST_EVENT1        ((Dem_EventIdType)20)
#define DemConf_DemEventParameter_Dem_FLS_COMPARE_ERROR    ((Dem_EventIdType)21)
#define DemConf_DemEventParameter_Dem_FLS_ERASE_ERROR      ((Dem_EventIdType)22)
#define DemConf_DemEventParameter_Dem_FLS_READ_ERROR       ((Dem_EventIdType)23)
#define DemConf_DemEventParameter_Dem_FLS_WRITE_ERROR      ((Dem_EventIdType)24)
#define DemConf_DemEventParameter_WDGM_E_IMPROPER_CALLER   ((Dem_EventIdType)25)
#define DemConf_DemEventParameter_WDGM_E_MONITORING        ((Dem_EventIdType)26)
#define DemConf_DemEventParameter_WDGM_E_SET_MODE          ((Dem_EventIdType)27)
#define DemConf_DemEventParameter_Dem_FEE_UNCONFIG_BLK_EXCEEDED_ERROR\
  ((Dem_EventIdType)28)
#define DemConf_DemEventParameter_Dem_FEE_GC_INIT_ERROR    ((Dem_EventIdType)29)
#define DemConf_DemEventParameter_Dem_FEE_GC_TRIG_ERROR    ((Dem_EventIdType)30)
#define DemConf_DemEventParameter_Dem_FEE_WRITE_ERROR      ((Dem_EventIdType)31)
#define DemConf_DemEventParameter_Dem_FEE_READ_ERROR       ((Dem_EventIdType)32)
#define DemConf_DemEventParameter_Dem_FEE_GC_WRITE_ERROR   ((Dem_EventIdType)33)
#define DemConf_DemEventParameter_Dem_FEE_GC_READ_ERROR    ((Dem_EventIdType)34)
#define DemConf_DemEventParameter_Dem_FEE_GC_ERASE_ERROR   ((Dem_EventIdType)35)
#define DemConf_DemEventParameter_Dem_FEE_INVALIDATE_ERROR ((Dem_EventIdType)36)
#define DemConf_DemEventParameter_NVM_E_INTEGRITY_FAILED   ((Dem_EventIdType)37)
#define DemConf_DemEventParameter_NVM_E_LOSS_OF_REDUNDANCY ((Dem_EventIdType)38)
#define DemConf_DemEventParameter_NVM_E_QUEUE_OVERFLOW     ((Dem_EventIdType)39)
#define DemConf_DemEventParameter_NVM_E_REQ_FAILED         ((Dem_EventIdType)40)
#define DemConf_DemEventParameter_NVM_E_VERIFY_FAILED      ((Dem_EventIdType)41)
#define DemConf_DemEventParameter_NVM_E_WRITE_PROTECTED    ((Dem_EventIdType)42)
#define DemConf_DemEventParameter_NVM_E_WRONG_BLOCK_ID     ((Dem_EventIdType)43)
...
#define DemConf_DemEventParameter_ECUM_E_IMPROPER_CALLER   ((Dem_EventIdType)47)
#define DemConf_DemEventParameter_EEP_E_COMPARE_FAILED     ((Dem_EventIdType)48)
#define DemConf_DemEventParameter_EEP_E_ERASE_FAILED       ((Dem_EventIdType)49)
#define DemConf_DemEventParameter_EEP_E_READ_FAILED        ((Dem_EventIdType)50)
#define DemConf_DemEventParameter_EEP_E_WRITE_FAILED       ((Dem_EventIdType)51)
#define DemConf_DemEventParameter_DEM_E_TEST_EVENT5        ((Dem_EventIdType)52)
#define DemConf_DemEventParameter_DEM_E_TEST_EVENT6        ((Dem_EventIdType)53)
#define DemConf_DemEventParameter_IOHWAB_E_WRONG_STATE     ((Dem_EventIdType)54)
#define DemConf_DemEventParameter_IOHWAB_E_WRONG_SETTING   ((Dem_EventIdType)55)
#define DemConf_DemEventParameter_IOHWAB_E_WRONG_PARAM     ((Dem_EventIdType)56)
#define DemConf_DemEventParameter_IOHWAB_E_SETUP_FAIL      ((Dem_EventIdType)57)
#define DemConf_DemEventParameter_IOHWAB_E_BUSY            ((Dem_EventIdType)58)
#define DemConf_DemEventParameter_IOHWAB_E_PROC_FAIL       ((Dem_EventIdType)59)
#define DemConf_DemEventParameter_CANCM_E_BAT_FAIL         ((Dem_EventIdType)60)
#define DemConf_DemEventParameter_RAMTST_E_RAM_FAILURE     ((Dem_EventIdType)61)
#define DemConf_DemEventParameter_ETHTRCV_E_ACCESS         ((Dem_EventIdType)62)
#define DemConf_DemEventParameter_ETHSM_E_LINK_DOWN        ((Dem_EventIdType)63)
#define DemConf_DemEventParameter_WDG_76_ACW_E_DISABLE_REJECTED\
  ((Dem_EventIdType)64)
#define DemConf_DemEventParameter_WDG_76_ACW_E_MODE_FAILED ((Dem_EventIdType)65)
#define DemConf_DemEventParameter_CAN_E_TIMEOUT            ((Dem_EventIdType)66)
#define DemConf_DemEventParameter_FEE_E_GC_ERASE           ((Dem_EventIdType)67)
#define DemConf_DemEventParameter_FEE_E_GC_INIT            ((Dem_EventIdType)68)
#define DemConf_DemEventParameter_FEE_E_GC_READ            ((Dem_EventIdType)69)
#define DemConf_DemEventParameter_FEE_E_GC_TRIG            ((Dem_EventIdType)70)
#define DemConf_DemEventParameter_FEE_E_GC_WRITE           ((Dem_EventIdType)71)
#define DemConf_DemEventParameter_FEE_E_INVALIDATE         ((Dem_EventIdType)72)
#define DemConf_DemEventParameter_FEE_E_READ               ((Dem_EventIdType)73)
#define DemConf_DemEventParameter_FEE_E_UNCONFIG_BLK_EXCEEDED ((Dem_EventIdType)74)
#define DemConf_DemEventParameter_FEE_E_WRITE              ((Dem_EventIdType)75)
#define DemConf_DemEventParameter_FEE_E_WRITE_CYCLES_EXHAUSTED\
  ((Dem_EventIdType)76)
#define DemConf_DemEventParameter_MCU_E_ERAY_TIMEOUT       ((Dem_EventIdType)77)
#define DemConf_DemEventParameter_MCU_E_OSC_FAILURE        ((Dem_EventIdType)78)
#define DemConf_DemEventParameter_SPI_E_DMA_TRANSFER       ((Dem_EventIdType)79)
#define DemConf_DemEventParameter_SPI_E_HARDWARE_ERROR     ((Dem_EventIdType)80)
#define DemConf_DemEventParameter_WDG_E_INIT_FAILED        ((Dem_EventIdType)81)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_DebugCANFD ((Dem_EventIdType)82)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_ECANFD   ((Dem_EventIdType)83)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_ACANFD1  ((Dem_EventIdType)84)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_ACANFD2  ((Dem_EventIdType)85)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_DebugCANFD\
  ((Dem_EventIdType)86)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_ECANFD ((Dem_EventIdType)87)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_ACANFD1 ((Dem_EventIdType)88)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_ACANFD2 ((Dem_EventIdType)89)
#define DemConf_DemEventParameter_MCU_E_CCU6_CLC_ENABLE_ERR ((Dem_EventIdType)90)
#define DemConf_DemEventParameter_MCU_E_CCU6_CLC_DISABLE_ERR ((Dem_EventIdType)91)
#define DemConf_DemEventParameter_MCU_E_CCUCON_UPDATE_ERR  ((Dem_EventIdType)92)
...
#define DemConf_DemEventParameter_MCU_E_CONVCTRL_CLC_DISABLE_ERR\
  ((Dem_EventIdType)94)
#define DemConf_DemEventParameter_MCU_E_GPT12_CLC_ENABLE_ERR ((Dem_EventIdType)95)
#define DemConf_DemEventParameter_MCU_E_GPT12_CLC_DISABLE_ERR ((Dem_EventIdType)96)
#define DemConf_DemEventParameter_MCU_E_GTM_CLC_ENABLE_ERR ((Dem_EventIdType)97)
#define DemConf_DemEventParameter_MCU_E_GTM_CLC_DISABLE_ERR ((Dem_EventIdType)98)
...
#define DemConf_DemEventParameter_MCU_E_PERIPHERAL_PLL_TIMEOUT_ERR\
  ((Dem_EventIdType)100)
#define DemConf_DemEventParameter_MCU_E_PMSWCR_UPDATE_ERR  ((Dem_EventIdType)101)
#define DemConf_DemEventParameter_MCU_E_SYSTEM_PLL_LOCK_LOSS ((Dem_EventIdType)102)
#define DemConf_DemEventParameter_MCU_E_SYSTEM_PLL_TIMEOUT_ERR\
  ((Dem_EventIdType)103)
#define DemConf_DemEventParameter_DEM_E_UDS_DTC_