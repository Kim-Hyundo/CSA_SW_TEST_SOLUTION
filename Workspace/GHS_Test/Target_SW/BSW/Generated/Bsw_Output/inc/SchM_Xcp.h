...
#define SCHM_Xcp_AR_RELEASE_MAJOR_VERSION	4
#define SCHM_Xcp_AR_RELEASE_MINOR_VERSION	0
#define SCHM_Xcp_AR_REVISION_VERSION			2

/* SOFTWARE VERSION INFORMATION */

#define SCHM_Xcp_SW_MAJOR_VERSION	4
#define SCHM_Xcp_SW_MINOR_VERSION	0
...
#include "MemMap.h"
extern FUNC(void, RTE_CODE) SchM_Enter_Xcp_DATA_PROTECTION_AREA(void);

extern FUNC(void, RTE_CODE) SchM_Exit_Xcp_DATA_PROTECTION_AREA(void);

extern FUNC(void, RTE_CODE) SchM_Enter_Xcp_BUSY_STATE_PROTECTION_AREA(void);

extern FUNC(void, RTE_CODE) SchM_Exit_Xcp_BUSY_STATE_PROTECTION_AREA(void);
