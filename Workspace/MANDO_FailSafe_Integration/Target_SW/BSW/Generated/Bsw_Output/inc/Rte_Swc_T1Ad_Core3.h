...
/*******************************************************************************
**  FILE-NAME: Rte_Swc_T1Ad_Core3.h                                                     **
**                                                                            **
...
*******************************************************************************/
 #ifndef RTE_SWC_T1AD_CORE3_H
      #define RTE_SWC_T1AD_CORE3_H
 /*
  * CAUTION:
  *
  * Do NOT
...
#include "Rte_Swc_T1Ad_Core3_Type.h"
...
#include "MemMap.h"
extern const struct Rte_CDS_Swc_T1Ad_Core3 Rte_Inst_Swc_T1Ad_Core3;
...
#define Swc_T1Ad_Core3_START_SEC_CODE
#include "Swc_T1Ad_Core3_MemMap.h"
FUNC(void, Swc_T1Ad_Core3_CODE) Runnable_T1Ad_Core3(void);

#define Swc_T1Ad_Core3_STOP_SEC_CODE
#include "Swc_T1Ad_Core3_MemMap.h"
...
** Runnables Mapping                                                          **
*******************************************************************************/
#ifndef RTE_RUNNABLE_Runnable_T1Ad_Core3
#define RTE_RUNNABLE_Runnable_T1Ad_Core3 Runnable_T1Ad_Core3
#endif
