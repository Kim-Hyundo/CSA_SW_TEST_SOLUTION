...
#include "MemMap.h"
FUNC(void, CAN_17_McmCan_CODE) Can_17_McmCan_MainFunction_BusOff(void);

FUNC(void, CAN_17_McmCan_CODE) Can_17_McmCan_17_McmCan_MainFunction_Mode(void);

FUNC(void, CAN_17_McmCan_CODE) Can_17_McmCan_MainFunction_Read(void);

FUNC(void, CAN_17_McmCan_CODE) Can_17_McmCan_17_McmCan_MainFunction_Wakeup(void);

FUNC(void, CAN_17_McmCan_CODE) Can_17_McmCan_MainFunction_Write(void);
