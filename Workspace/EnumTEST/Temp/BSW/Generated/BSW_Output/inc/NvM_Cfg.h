...
#define NVM_SIZE_STANDARD_JOB_QUEUE         ((uint8)26)
...
#define NVM_TOTAL_NUM_OF_WRITEALL_BLOCKS    18
...
#define NVM_BLOCKS_NOT_CONFIG_WRITEALL      9
...
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_2\
  ((NvM_BlockIdType)6)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_3\
  ((NvM_BlockIdType)7)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_4\
  ((NvM_BlockIdType)8)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_5\
  ((NvM_BlockIdType)9)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_6\
  ((NvM_BlockIdType)10)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_7\
  ((NvM_BlockIdType)11)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_8\
  ((NvM_BlockIdType)12)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_9\
  ((NvM_BlockIdType)13)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemSecondaryEventMemory_0\
  ((NvM_BlockIdType)14)
...
#define NvMConf_NvMBlockDescriptor_NvMBlock_IntTst_TestBlock3\
  ((NvM_BlockIdType)17)
#define NvMConf_NvMBlockDescriptor_NvMBlock_IDC_DCD_Segment ((NvM_BlockIdType)18)
#define NvMConf_NvMBlockDescriptor_NvMBlock_IDC_USM_Segment ((NvM_BlockIdType)19)
#define NvMConf_NvMBlockDescriptor_NvMBlock_VDISP_Segment  ((NvM_BlockIdType)20)
#define NvMConf_NvMBlockDescriptor_NvMBlock_IDS_Segment    ((NvM_BlockIdType)21)
...
#define NvMConf_NvMBlockDescriptor_NvMBlock_Traceability_Segment\
  ((NvM_BlockIdType)26)
#define NvMConf_NvMBlockDescriptor_NvMBlock_EDR_Segment    ((NvM_BlockIdType)27)
