...
#include "MemMap.h"
extern FUNC(void, RTE_CODE) SchM_Enter_Gpt_Get1UsPredefTimerValue(void);

extern FUNC(void, RTE_CODE) SchM_Exit_Gpt_Get1UsPredefTimerValue(void);

extern FUNC(void, RTE_CODE) SchM_Enter_Gpt_Get100UsPredefTimerValue(void);

extern FUNC(void, RTE_CODE) SchM_Exit_Gpt_Get100UsPredefTimerValue(void);

extern FUNC(void, RTE_CODE) SchM_Enter_Gpt_GtmStartTimer(void);

extern FUNC(void, RTE_CODE) SchM_Exit_Gpt_GtmStartTimer(void);
