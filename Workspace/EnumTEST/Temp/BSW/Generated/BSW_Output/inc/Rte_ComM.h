...
extern FUNC(Std_ReturnType, RTE_CODE)
/* polyspace<MISRA2012:2.7:Not a defect:Justify with annotations> AUTOSAR Standard sws_rte_01071 */
Rte_Write_ComM_CR003_P_fullComRequestors(IN P2CONST(ComM_UserHandleArrayType, AUTOMATIC, RTE_APPL_DATA) Data);
...
#ifndef Rte_Write_CR003_P_fullComRequestors
#define Rte_Write_CR003_P_fullComRequestors \
  Rte_Write_ComM_CR003_P_fullComRequestors
#endif
