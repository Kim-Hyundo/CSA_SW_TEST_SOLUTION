...
*******************************************************************************/
 #ifndef RTE_ECUM_SLAVE2_H
      #define RTE_ECUM_SLAVE2_H
 /*
  * CAUTION:
  *
  * Do NOT
...
#include "Rte_EcuM_Slave2_Type.h"
...
#include "MemMap.h"
extern const struct Rte_CDS_EcuM_Slave2 Rte_Inst_EcuM_Slave2;
...
#define EcuM_Slave2_START_SEC_CODE
#include "EcuM_Slave2_MemMap.h"
FUNC(void, EcuM_Slave2_CODE) EcuM_MainFunction2(void);

#define EcuM_Slave2_STOP_SEC_CODE
#include "EcuM_Slave2_MemMap.h"
...
** Runnables Mapping                                                          **
*******************************************************************************/
#ifndef RTE_RUNNABLE_EcuM_MainFunction2
#define RTE_RUNNABLE_EcuM_MainFunction2 EcuM_MainFunction2
#endif
