...
class MandoTestspecParser_10(TestspecParser):
    ...
    def parsing_rule(self, data_tmp, origin_data, alldata, index):
        ...
        elif origin_data["Direction"] == "Tx" and origin_data["Receiver"] == "Main_CAN" and origin_data[
            "Sheet"] == "IVC":  # Dtype - IVC modelvar , signal
