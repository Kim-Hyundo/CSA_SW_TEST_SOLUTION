...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
         ...
         */
#if __BIV_INIT
#if __BIV_SINGLE_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#else
#if ( defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#if ( defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
