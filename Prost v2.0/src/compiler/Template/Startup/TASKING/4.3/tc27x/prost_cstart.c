...
#include "prost_cstart.h"                             /* include configuration */
...
/* library references */
#pragma extern main_core0
extern int main_core0( int argc, char *argv[] );
...
#if ( defined _REGUSERDEF16X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#if ( defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
/* c init semaphores */
#if (defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC29X_H)
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
         ...
         */
#if __BIV_INIT
#if __BIV_SINGLE_INIT && (defined _REGUSERDEF16X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC2D5T_H || defined _REGTC2X7_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_INIT && (defined _REGUSERDEF16X_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#define __SCU_PLLCON1__K2DIV_VALUE      ((__SCU_PLLCON1_VALUE>>0)&0x3f)
        ...
        || defined _REGTC2D5T_H || defined _REGTC27X_H  || defined _REGTC27XB_H || defined _REGTC26X_H \
        || defined _REGTC29X_H)
#if     ( defined _REGTC2D5T_H )
#define PLL_K2_RAMPUP_STM_CLC_RMC       (STM0_CLC.B.RMC)
#else
#if ( defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#  endif
         ...
         */
#if __USE_ARGC_ARGV
        exit( main_core0( _argcv( argcv, __ARGCV_BUFSIZE ), (char **)argcv ) );
#else
        exit( main_core0( 0, NULL ) );                /* argc is 0 */
#endif
...
#if ( defined _REGTC2D5T_H || defined _REGTC23X_ADAS_H || defined _REGTC23X_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
