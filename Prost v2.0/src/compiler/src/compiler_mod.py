...
def targetSWCopy(dic_project_info):
    ...
    #dic_project_info['Compiler']['IsExistMainls']='TRUE'
    if dic_project_info['Compiler']['IsExistMainls'] == 'TRUE':
        log_mod.set_log('## Func: TRUETRUETRUETRUETRUETRUE', log_mod.Logtype_PFF)
        copyTree(dic_project_info['Common_Path'], template_path + "\\Linkerscript\\" + dic_project_info['Test_Env']['Test_CPU'], target_sw_path)
        ...
        copyTree(dic_project_info['Common_Path'], template_path + "\\Linkerscript_prost\\" + dic_project_info['Test_Env']['Test_CPU'], target_sw_path)
