...
#include "prost_cstart_tc1.h"         /* include configuration */
...
#pragma extern main_core1
extern int main_core1( int argc, char *argv[] );
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
         ...
         */
#if __BIV_TC1_INIT
#if __BIV_SINGLE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H  || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_TC1_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#define __COREN_HALT__          ( ( (CPU1_DBGSR.B.HALT & 0x1)==0 ) << 1 )
         ...
         */
#if __USE_ARGC_ARGV_TC1
        exit( main_core1( _argcv( argcv_tc1, __ARGCV_BUFSIZE_TC1), (char **)argcv_tc1) );
#else
        exit( main_core1( 0, NULL ) );                /* argc is 0 */
#endif
