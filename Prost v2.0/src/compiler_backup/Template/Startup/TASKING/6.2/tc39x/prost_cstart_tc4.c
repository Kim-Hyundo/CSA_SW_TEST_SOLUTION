...
#include "prost_cstart_tc4.h"         /* include configuration */
...
#pragma extern main_core4
extern int main_core4( int argc, char *argv[] );
...
#  define MAX_NR_OF_CSA_AREAS     1
         ...
         */
#if __USE_ARGC_ARGV_TC4
        exit( main_core4( _argcv( argcv_tc4, __ARGCV_BUFSIZE_TC4), (char **)argcv_tc4) );
#else
        exit( main_core4( 0, NULL ) );                /* argc is 0 */
#endif
