...
int main(void)
{
	...
	short int  inc, sign;
	char      *p;
	// Disable watchdog functionality of TLF35584 power supply of TriBoard
	if(bDisableTlf35584){
		tDisableTLF35584Result result;
		DisableTlf35584(&result);
	}
