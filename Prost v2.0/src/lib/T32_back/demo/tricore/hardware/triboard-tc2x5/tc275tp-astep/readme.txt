; --------------------------------------------------------------------------------
; @Title: README for TC275TP-Astep on TriBoard-TC2x5
; @Description:
...
tc275tp-astep_smp_demo_multisieve_flash.cmm:
...
tc275tp-astep_amp_demo_multisieve_start_core0.bat:
...
tc275tp-astep_smp_demo_waveform.cmm:
...
tc275tp-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
