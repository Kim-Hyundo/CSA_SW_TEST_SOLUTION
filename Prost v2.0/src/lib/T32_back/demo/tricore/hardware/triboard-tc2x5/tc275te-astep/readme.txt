; --------------------------------------------------------------------------------
; @Title: README for TC275TE-Astep on TriBoard-TC2x5
; @Description:
...
tc275te-astep_smp_demo_multisieve_flash.cmm:
...
tc275te-astep_amp_demo_multisieve_start_core0.bat:
...
tc275te-astep_smp_demo_waveform.cmm:
...
tc275te-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
