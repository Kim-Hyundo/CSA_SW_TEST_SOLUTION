; --------------------------------------------------------------------------------
; @Title: README for TC277T-Astep on TriBoard-TC2x7
; @Description:
...
tc277t-astep_smp_demo_multisieve_flash.cmm:
...
tc277t-astep_amp_demo_multisieve_start_core0.bat:
...
tc277t-astep_smp_demo_waveform.cmm:
...
tc277t-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
