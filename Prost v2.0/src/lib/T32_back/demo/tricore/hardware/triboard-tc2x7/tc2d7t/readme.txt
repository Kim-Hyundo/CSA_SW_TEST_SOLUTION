; --------------------------------------------------------------------------------
; @Title: README for TC2D7T on TriBoard-TC2x7
; @Description:
...
tc2d7t_amp_demo_multisieve.cmm:
  Loads the multisieve demo application (multi-core) into RAM and sets up a
...
tc2d7t_amp_demo_multisieve_start_core0.bat:
