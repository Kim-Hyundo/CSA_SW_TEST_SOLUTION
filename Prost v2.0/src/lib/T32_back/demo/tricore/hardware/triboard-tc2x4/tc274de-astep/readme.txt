; --------------------------------------------------------------------------------
; @Title: README for TC274DE-Astep on TriBoard-TC2x4
; @Description:
...
tc274de-astep_smp_demo_multisieve_flash.cmm:
...
tc274de-astep_amp_demo_multisieve_start_core0.bat:
...
tc274de-astep_smp_demo_waveform.cmm:
...
tc274de-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
