...
// @Description:
//   This example show how to instrument your application for using the instumented
//   OCDS-L2 data trace in your application.
//
...
// --------------------------------------------------------------------------------
// $Id: tracedemo.c 8303 2015-04-08 12:30:35Z mobermaier $
...
{
    (*jumptab[((value>>8) & 0xff)])();
}

extern void T32_DataTrace_Write8();
extern void T32_DataTrace_Write32();
...
public:
	...
	virtual int method3(nestxf & ref)
	{
		return x+ref.x;
	}
	int x;
...
void cpp_func5()
{
	...
	for (i = 0 ; i < 3 ; i++) {
	   ...
	   mstatic1 = nestxfarray[i]->method2(i);
	   mstatic1 = nestxfarray[i]->method3(vnestxf2);
	   mstatic1 = nestxfarray[i]->method3(*nestxfarray[0]);
	}
}
...
int main()
{
	...
	T32_DataTrace_Write8(&vtripplearray[0][0][0],1);

	vtripplearray[1][0][0] = 2;
	T32_DataTrace_Write8(&vtripplearray[1][0][0],2);

	vtripplearray[0][1][0] = 3;
	T32_DataTrace_Write8(&vtripplearray[0][1][0],3);

	vtripplearray[0][0][1] = 4;
	T32_DataTrace_Write8(&vtripplearray[0][0][1],4);
