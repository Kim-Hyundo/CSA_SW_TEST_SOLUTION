; --------------------------------------------------------------------------------
; @Title: README for TriBoard with TC1796-based processors
; @Description:
...
triboard-tc1796_sieve_intmem.elf
    Lauterbach sieve demo for running from external RAM.
triboard-tc1796_sieve_intflash.elf
