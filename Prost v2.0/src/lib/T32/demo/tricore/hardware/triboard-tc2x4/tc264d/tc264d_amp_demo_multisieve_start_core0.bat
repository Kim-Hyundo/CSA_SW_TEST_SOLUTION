@ECHO OFF
REM --------------------------------------------------------------------------------
REM @Title: Batch file for TC264D on TRIBOARD-TC2X4
REM @Description:
...
REM   Other core(s) will be started by the tc264d_amp_demo_multisieve.cmm
REM   practice script.
REM @Board: TriBoard-TC2x4
REM @Chip: TC264D
REM @Copyright: (C) 1989-2020 Lauterbach GmbH, licensed for use with TRACE32(R) only
REM --------------------------------------------------------------------------------
REM $Id: tc264d_amp_demo_multisieve_start_core0.bat 15579 2020-01-27 15:08:53Z sltaief $
...
start %T32MTC_EXE% -c config_multicore.t32 %P1_PORT% %P2_TITLE% %P3_TMP% %P4_SYS% %P5_HELP% %P6_PBI% %P7_OPT% %P8_OPT% %P9_OPT% -s tc264d_amp_demo_multisieve.cmm
