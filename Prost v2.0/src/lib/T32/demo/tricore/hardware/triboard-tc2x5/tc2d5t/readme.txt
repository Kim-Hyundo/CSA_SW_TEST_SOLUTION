; --------------------------------------------------------------------------------
; @Title: README for TC2D5T on TriBoard-TC2x5
; @Description:
...
tc2d5t_amp_demo_multisieve.cmm:
  Loads the multisieve demo application (multi-core) into RAM and sets up a
...
tc2d5t_amp_demo_multisieve_start_core0.bat:
