; --------------------------------------------------------------------------------
; @Title: README for TC275TF-Astep on TriBoard-TC2x5
; @Description:
...
tc275tf-astep_smp_demo_multisieve_flash.cmm:
...
tc275tf-astep_amp_demo_multisieve_start_core0.bat:
...
tc275tf-astep_smp_demo_waveform.cmm:
...
tc275tf-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
