; --------------------------------------------------------------------------------
; @Title: README for TC277TU-Astep on TriBoard-TC2x7
; @Description:
...
tc277tu-astep_smp_demo_multisieve_flash.cmm:
...
tc277tu-astep_amp_demo_multisieve_start_core0.bat:
...
tc277tu-astep_smp_demo_waveform.cmm:
...
tc277tu-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
