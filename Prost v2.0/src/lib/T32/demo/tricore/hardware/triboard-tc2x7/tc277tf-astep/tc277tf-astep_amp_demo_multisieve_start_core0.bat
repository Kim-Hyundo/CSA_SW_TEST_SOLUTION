@ECHO OFF
REM --------------------------------------------------------------------------------
REM @Title: Batch file for TC277TF-Astep on TRIBOARD-TC2X7
REM @Description:
...
REM   tc277tf-astep_amp_demo_multisieve.cmm practice script.
REM @Board: TriBoard-TC2x7
REM @Chip: TC277TF
REM @Copyright: (C) 1989-2020 Lauterbach GmbH, licensed for use with TRACE32(R) only
REM --------------------------------------------------------------------------------
REM $Id: tc277tf-astep_amp_demo_multisieve_start_core0.bat 15579 2020-01-27 15:08:53Z sltaief $
...
start %T32MTC_EXE% -c config_multicore.t32 %P1_PORT% %P2_TITLE% %P3_TMP% %P4_SYS% %P5_HELP% %P6_PBI% %P7_OPT% %P8_OPT% %P9_OPT% -s tc277tf-astep_amp_demo_multisieve.cmm
