; --------------------------------------------------------------------------------
; @Title: README for TC277TP-Astep on TriBoard-TC2x7
; @Description:
...
tc277tp-astep_smp_demo_multisieve_flash.cmm:
...
tc277tp-astep_amp_demo_multisieve_start_core0.bat:
...
tc277tp-astep_smp_demo_waveform.cmm:
...
tc277tp-astep_amp_demo_waveform.cmm:
  Loads the waveform generation demo application (multi-core) into RAM and sets
