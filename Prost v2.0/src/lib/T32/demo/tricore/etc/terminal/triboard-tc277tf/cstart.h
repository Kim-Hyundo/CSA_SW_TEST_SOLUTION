...
#endif
#define __HALT_VALUE_TC1        0x2     /* Set HALT value of TC1 */
                                        /* 0 R:running W:unchanged
                                           1 R:halted W:unchanged
                                           2 R:n.a. W:reset halt
                                           3 R:n.a. W:set when debug enable
                                        */
#define __HALT_VALUE_TC2        0x2     /* Set HALT value of TC2 */
                                        /* 0 R:running W:unchanged
                                           1 R:halted W:unchanged
                                           2 R:n.a. W:reset halt
                                           3 R:n.a. W:set when debug enable
...
#define __SCU_CCUCON2_VALUE     0x000004b4
...
#define __FLASH0_FCON_VALUE     0x00a11255
