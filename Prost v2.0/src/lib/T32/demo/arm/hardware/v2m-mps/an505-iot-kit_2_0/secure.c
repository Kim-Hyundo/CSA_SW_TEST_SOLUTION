...
const char cstr[] = "Constant String1 in Secure";
unsigned int nCount = 0;
static signed short nPwm25 = 0, nPwm64 = 0;
...
int __attribute__ ((cmse_nonsecure_entry)) secure_func10(void)
{
	...
	nPwm25 = ( (nCount % period) >= period*25/100 ) ?  0 : 25000;
	nPwm64 = ( (nCount % period) >= period*64/100 ) ?  0 : 20000;
	nCount++;
