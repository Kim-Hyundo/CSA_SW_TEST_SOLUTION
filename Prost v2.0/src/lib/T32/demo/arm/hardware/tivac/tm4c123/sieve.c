...
int main(void)
{
	...
	/* before initializing CORE Registers/Periperhals      */
	/* PLLs/... add a busy waiting loop of 2xWaitResetTime */
	/* The values here use the SYSTICK CALIBRATION VALUES  */
	/* to implement a 10*10ms=100ms delay. */
	for (j = 0; j < 10; j++)
	{
		*((unsigned long*) 0xe000e010) = 0x0; // SYST_CSR - disable
		*((unsigned long*) 0xe000e014) = 0x0; // SYST_RVR
		*((unsigned long*) 0xe000e018) = 0x0; // SYST_CVR
		*((unsigned long*) 0xe000e014) = *((unsigned long*)0xe000e01c)&0x00ffffff;
		*((unsigned long*) 0xe000e010) = 0x1; // SYST_CSR - enable
		// wait will underflow occurs
		while (*((unsigned long*) 0xe000e010) == 0x1);
	}
	*((unsigned long*) 0xe000e010) = 0x0; // SYST_CSR - disable
	/* Now we are ready to do HW initialization  */
