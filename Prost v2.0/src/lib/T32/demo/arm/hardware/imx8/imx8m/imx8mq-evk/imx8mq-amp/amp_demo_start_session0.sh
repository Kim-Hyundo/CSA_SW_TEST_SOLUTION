...
# --------------------------------------------------------------------------------
# $Id: amp_demo_start_session0.sh 13801 2019-01-18 15:53:49Z bschroefel $
...
# Try to find t32marm64 executable
T32MARCH_EXE=${P4_SYS}/bin/${MACHINE}/t32marm64-qt
if [ ! -x ${T32MARCH_EXE} ]; then
  ...
  T32MARCH_EXE=${ppwd}/../../../../../../../bin/${MACHINE}/t32marm64-qt
  P4_SYS=${ppwd}/../../../../../../..
fi

if [ ! -x ${T32MARCH_EXE} ]; then
  echo "t32marm64-qt not found."
...
${T32SYS}/bin/${MACHINE}/t32marm64-qt -c "${ppwd}/config_amp.t32" ${P1_PORT} ${P2_TITLE} ${P3_TMP} ${P4_SYS} ${P5_PBI} ${P6_OPT} ${P7_OPT} ${P8_OPT} -s "${ppwd}/"t32_amp.cmm
