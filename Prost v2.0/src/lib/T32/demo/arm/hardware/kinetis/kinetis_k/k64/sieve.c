...
typedef volatile struct 
       { 
                  unsigned int var_MonNom; 
                  unsigned int var_MonTableau[4000]; 
       }typ_StructureTableau; 
       
typ_StructureTableau v_str_TableauAEcrire;

void FonctionAMesurer() 
{
      typ_StructureTableau *str_TableauAEcrire = &v_str_TableauAEcrire; 

      unsigned int var_boucle=0; 
      for (var_boucle  = 0;var_boucle < 100; var_boucle++) 
      { 
                     str_TableauAEcrire->var_MonTableau[var_boucle] = var_boucle;
      } 
} 
