...
#include "math.h"
   ...
   *  in every program that uses the BSL. */
#include "dsk6455.h"
...
int intrinsic_variable1;
int intrinsic_variable2;
...
int main()
{
	...
	vtripplearray[0][0][1] =  2;
	vtripplearray[0][0][2] =  3;
	vtripplearray[0][0][3] =  4;
	
	vtripplearray[0][1][0] =  5;
	vtripplearray[0][1][1] =  6;
	vtripplearray[0][1][2] =  7;
	vtripplearray[0][1][3] =  8;
	
	vtripplearray[0][2][0] =  9;
	vtripplearray[0][2][1] = 10;
	vtripplearray[0][2][2] = 11;
	vtripplearray[0][2][3] = 12;
	
	vtripplearray[1][0][0] = 13;
	vtripplearray[1][0][1] = 14;
	vtripplearray[1][0][2] = 15;
	vtripplearray[1][0][3] = 16;
	
	vtripplearray[1][1][0] = 17;
	vtripplearray[1][1][1] = 18;
	vtripplearray[1][1][2] = 19;
	vtripplearray[1][1][3] = 20;
	
	vtripplearray[1][2][0] = 21;
	vtripplearray[1][2][1] = 22;
	vtripplearray[1][2][2] = 23;
	vtripplearray[1][2][3] = 24;
