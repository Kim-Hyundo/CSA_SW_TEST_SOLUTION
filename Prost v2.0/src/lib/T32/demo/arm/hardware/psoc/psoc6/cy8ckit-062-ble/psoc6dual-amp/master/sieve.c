...
extern unsigned int __data_laddr;
extern unsigned int __data_vaddr;
extern void enable_m4(unsigned int nM4Vtor);
...
int main(void)
{
	...
	// only if linked to FLASH kick the M4
	if (__data_laddr != __data_vaddr)
		enable_m4(0x10010000);
