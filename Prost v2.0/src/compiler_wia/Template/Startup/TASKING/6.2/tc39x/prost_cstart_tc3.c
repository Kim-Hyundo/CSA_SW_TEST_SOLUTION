...
#include "prost_cstart_tc3.h"         /* include configuration */
...
#pragma extern main_core3
extern int main_core3( int argc, char *argv[] );
...
#  define MAX_NR_OF_CSA_AREAS     1
         ...
         */
#if __USE_ARGC_ARGV_TC3
        exit( main_core3( _argcv( argcv_tc3, __ARGCV_BUFSIZE_TC3), (char **)argcv_tc3) );
#else
        exit( main_core3( 0, NULL ) );                /* argc is 0 */
#endif
