...
#include "prost_cstart_tc5.h"         /* include configuration */
...
#pragma extern main_core5
extern int main_core5( int argc, char *argv[] );
...
#  define MAX_NR_OF_CSA_AREAS     1
         ...
         */
#if __USE_ARGC_ARGV_TC5
        exit( main_core5( _argcv( argcv_tc5, __ARGCV_BUFSIZE_TC5), (char **)argcv_tc5) );
#else
        exit( main_core5( 0, NULL ) );                /* argc is 0 */
#endif
