...
#include "prost_cstart_tc2.h"         /* include configuration */
...
#pragma extern main_core2
extern int main_core2( int argc, char *argv[] );
...
static void __noinline__ __noreturn__ __jump__ _start( void )
{
         ...
         */
#if __BIV_TC2_INIT
#if __BIV_SINGLE_TC2_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H  || defined _REGTC29X_H)
        /*
...
#else
#if __BIV_8BYTE_TC2_INIT && (defined _REGUSERDEF16X_H || defined _REGTC2D5T_H || defined _REGTC27X_H || defined _REGTC27XB_H || defined _REGTC26X_H || defined _REGTC29X_H)
...
#define __COREN_HALT__          ( ( (CPU1_DBGSR.B.HALT & 0x1)==0 ) << 1 )
         ...
         */
#if __USE_ARGC_ARGV_TC2
        exit( main_core2( _argcv( argcv_tc2, __ARGCV_BUFSIZE_TC2), (char **)argcv_tc2) );
#else
        exit( main_core2( 0, NULL ) );                /* argc is 0 */
#endif
